...
// react router ka data loader se same cheez as fetch kar sakte aur data export bhi kar sakte
...
const SingleJobPage = ({ deleteJob }) => {
    ...
    const onDeleteClick = (jobId) => {
        const confirm = window.confirm("Are you sure you want to to delete this listing?");

        // if confirm is 0 --> then we return
        if (!confirm) return;
